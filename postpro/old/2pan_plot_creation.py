...
coords = pd.read_csv('/home/michael.optis@enxco.com/mys3/turbines/longhorn/windturbines_longhorn_all_farms.txt', delim_whitespace=True, header = None)
...
ndata = Dataset('./longhorn_template.nc')
