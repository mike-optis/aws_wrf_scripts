...
h5_file = '%s/h5/custom/%s-%s_2017_%s.h5' % (root_dir, wps, wrf, month, )
#h5_file = '%s/h5_bad/ensembles/Offshore_CA_%s-%s_2017.h5' % (root_dir, wps, wrf,)
print(h5_file)
if os.path.exists(h5_file):
    ...
    pk.dump(mod_dict, open(out_dir+'%s_WRF%s_mod_data.p' % (wps, wrf,), 'wb'))
